...
"resource": {
  ...
  "tags":[{
      ...
      "once_per_event":true,
      "vtp_overrideGaSettings":false,
      "vtp_optimizeContainerId":"GTM-NKSX349",
      "vtp_gaSettings":["macro",7],
      "tag_id":11
    },{
      "function":"__ua",
      ...
      "vtp_uniqueTriggerId":"8908888_14",
      ...
      "vtp_uniqueTriggerId":"8908888_47",
      "vtp_enableTriggerStartOption":true,
      "tag_id":59
    },{
      "function":"__cl",
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(a){a.fn.iframeTracker=function(b){\"function\"==typeof b\u0026\u0026(b={blurCallback:b});var c=this.get();if(null===b||!1===b)a.iframeTracker.untrack(c);else if(\"object\"==typeof b)a.iframeTracker.track(c,b);else throw Error(\"Wrong handler type (must be an object, or null|false to untrack)\");return this};a.iframeTracker={focusRetriever:null,focusRetrieved:!1,handlersList:[],isIE8AndOlder:!1,init:function(){try{!0===a.browser.msie\u0026\u00269\u003Ea.browser.version\u0026\u0026(this.isIE8AndOlder=!0)}catch(c){try{var b=navigator.userAgent.match(\/(msie) ([\\w.]+)\/i);\n9\u003Eb[2]\u0026\u0026(this.isIE8AndOlder=!0)}catch(d){}}a(window).focus();a(window).blur(function(c){a.iframeTracker.windowLoseFocus(c)});a(\"body\").append('\\x3cdiv style\\x3d\"position:fixed; top:0; left:0; overflow:hidden;\"\\x3e\\x3cinput style\\x3d\"position:absolute; left:-300px;\" type\\x3d\"text\" value\\x3d\"\" id\\x3d\"focus_retriever\" readonly\\x3d\"true\" \/\\x3e\\x3c\/div\\x3e');this.focusRetriever=a(\"#focus_retriever\");this.focusRetrieved=!1;if(this.isIE8AndOlder){this.focusRetriever.blur(function(c){c.stopPropagation();\nc.preventDefault();a.iframeTracker.windowLoseFocus(c)});a(\"body\").click(function(c){a(window).focus()});a(\"form\").click(function(a){a.stopPropagation()});try{a(\"body\").on(\"click\",\"form\",function(a){a.stopPropagation()})}catch(c){console.log(\"[iframeTracker] Please update jQuery to 1.7 or newer. (exception: \"+c.message+\")\")}}},track:function(b,c){c.target=b;a.iframeTracker.handlersList.push(c);a(b).bind(\"mouseover\",{handler:c},a.iframeTracker.mouseoverListener).bind(\"mouseout\",{handler:c},a.iframeTracker.mouseoutListener)},\nuntrack:function(b){if(\"function\"!=typeof Array.prototype.filter)console.log(\"Your browser doesn't support Array filter, untrack disabled\");else{a(b).each(function(b){a(this).unbind(\"mouseover\",a.iframeTracker.mouseoverListener).unbind(\"mouseout\",a.iframeTracker.mouseoutListener)});var c=function(a){return null===a?!1:!0},d;for(d in this.handlersList){for(var e in this.handlersList[d].target)-1!==a.inArray(this.handlersList[d].target[e],b)\u0026\u0026(this.handlersList[d].target[e]=null);this.handlersList[d].target=\nthis.handlersList[d].target.filter(c);0===this.handlersList[d].target.length\u0026\u0026(this.handlersList[d]=null)}this.handlersList=this.handlersList.filter(c)}},mouseoverListener:function(b){b.data.handler.over=!0;a.iframeTracker.retrieveFocus();try{b.data.handler.overCallback(this,b)}catch(c){}},mouseoutListener:function(b){b.data.handler.over=!1;a.iframeTracker.retrieveFocus();try{b.data.handler.outCallback(this,b)}catch(c){}},retrieveFocus:function(){document.activeElement\u0026\u0026\"IFRAME\"===document.activeElement.tagName\u0026\u0026\n(a.iframeTracker.focusRetriever.focus(),a.iframeTracker.focusRetrieved=!0)},windowLoseFocus:function(a){for(var b in this.handlersList)if(!0===this.handlersList[b].over)try{this.handlersList[b].blurCallback(a)}catch(d){}}};a(document).ready(function(){a.iframeTracker.init()})})(jQuery);\njQuery(document).ready(function(a){a(\"iframe\").iframeTracker({blurCallback:function(a){dataLayer.push({event:\"adClicked\",eventCategory:\"Klikni\\u0119cie w reklame\",eventAction:a.target.ampInaboxIframes[0].id,eventLabel:void 0,eventValue:void 0})}})});\u003C\/script\u003E",
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,e,f,g,b,c,d){a[b]=a[b]||function(){(a[b].a=a[b].a||[]).push(arguments)};a[b].l=1*new Date;c=e.createElement(f);d=e.getElementsByTagName(f)[0];c.async=1;c.src=g;d.parentNode.insertBefore(c,d)})(window,document,\"script\",\"https:\/\/mc.yandex.ru\/metrika\/tag.js\",\"ym\");ym(51969350,\"init\",{id:51969350,clickmap:!0,trackLinks:!0,accurateTrackBounce:!0,webvisor:!0});\u003C\/script\u003E\n\u003Cnoscript\u003E\u003Cdiv\u003E\u003Cimg src=\"https:\/\/mc.yandex.ru\/watch\/51969350\" style=\"position:absolute; left:-9999px;\" alt=\"\"\u003E\u003C\/div\u003E\u003C\/noscript\u003E\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":10
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,c,e,f,d,b){a.hj=a.hj||function(){(a.hj.q=a.hj.q||[]).push(arguments)};a._hjSettings={hjid:2029233,hjsv:6};d=c.getElementsByTagName(\"head\")[0];b=c.createElement(\"script\");b.async=1;b.src=e+a._hjSettings.hjid+f+a._hjSettings.hjsv;d.appendChild(b)})(window,document,\"https:\/\/static.hotjar.com\/c\/hotjar-\",\".js?sv\\x3d\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":56
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",4],
      "arg1":"btn btn-outline btn-green dn-btn"
    },{
      "function":"_re",
      "arg0":["macro",8],
      "arg1":"^\/(check-warranty-unlock|services\/apple-carrier-lock-status\/apple\/check-paid|cart\/orders\/[^\/]+|services\/apple-carrier-lock-status\/[^\/]+)\/$"
    }],
  "rules":[
    [["if",0],["add",0,5,12,13,8,9,10,11]],
    [["if",1],["add",1]],
    [["if",2,3,4],["add",2]],
    [["if",5,6],["add",3]],
    [["if",7],["add",4]],
...
"set",t);f(h+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(h+"require","render");a||(a=!0,N(p,function(){return Sh().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var u=V("dataLayer"),v=u&&u.hide;v&&(v.end||!0===v["GTM-5DZWXH4"])&&(v[b.vtp_optimizeContainerId]=!0)}else I(b.vtp_gtmOnFailure)})}();
